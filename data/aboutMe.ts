...
const ABOUT__ME__LIST: aboutMelist = [
  ...
  },
  {
    ...
    content:
      "Experienced in building responsive, user-friendly web applications and interfaces. Proficient in modern frontend technologies like React.js, Next.js, HTML, CSS, and JavaScript. Skilled in translating design concepts into functional, interactive web pages while ensuring performance and accessibility.",
  },
  {
    id: 3,
